    ...
    <section className="flex min-h-screen bg-zinc-50 px-4 py-16 md:py-32 dark:bg-transparent">
      <div className="bg-card m-auto h-fit w-full max-w-md rounded-lg border p-0.5 shadow-md">
        <div className="p-8 pb-6">
          ...
          <h1 className="mb-1 mt-4 text-xl font-semibold">Buat akun baru</h1>
          <p className="text-sm text-muted-foreground">Selamat datang! Silakan isi detail Anda untuk memulai</p>

          <div className="mt-6 gap-3">
            <Button className='w-full' type="button" variant="outline" disabled={isLoading} onClick={() => handleSocialSignIn("google")}>
